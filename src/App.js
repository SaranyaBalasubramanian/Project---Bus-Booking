...
import AddBusDetails from './components/AddBuses';
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route exact path="/" element={<TopSlider></TopSlider>}></Route>
          ...
          <Route exact path="/addbuses" element={<AddBusDetails></AddBusDetails>}></Route>
